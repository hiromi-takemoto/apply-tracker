...
import { formatYen, genreLabel, GENRE_LABELS, PLATFORM_LABELS, STATUS_LABELS, type ApplicationPlatform, type ApplicationStatus, type GenreMajor } from "@/lib/applications";
